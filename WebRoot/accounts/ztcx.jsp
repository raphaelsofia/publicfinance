...
<%@ page import = "com.accounts.models.Account"%>
	...
	<body>
		...
		<div id="zhukuai">
				...
				<table class="zhuti" style="width: 100%">
					<tr>
						<div style="float: left" id="my_menu">
						      <div>
						        <span>帐套管理</span>
							        <a href="../servlet/DisplayDanWeiInfo">单位设置</a>
							        <a href="">用户管理</a>
							        <a href="">帐套设置</a>
							        <a href="">科目设置</a>
			...
			<tr><th>帐套代码</th><th>单位名称</th></tr>
			 ...
			 <%
						 	ArrayList<Account> list = (ArrayList<Account>)session.getAttribute("allAccountInfo");
						 	 
						 	 for(Account a : list){				out.println("<tr><td>"+a.getDwdm()+"</td><td>"+a.getDwmc()+"</td></tr>");	
						 							}
						 %> 	
